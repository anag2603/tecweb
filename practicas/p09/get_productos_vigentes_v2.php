                ...
                <tbody>
                    <?php foreach ($productos as $row) : ?>
                        <tr>
                            ...
                            <td><a href="formulario_productos_v2.php?id=<?= $row['id'] ?>" class="btn btn-primary">Modificar</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        <?php else: ?>
            <p class="alert alert-warning">No se encontraron productos con unidades menores o iguales a <?= htmlspecialchars($tope) ?> y no eliminados.</p>
        <?php endif; ?>
    </div>
</body>
</html>
